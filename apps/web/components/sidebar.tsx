  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-border bg-card">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-border px-6">
        ...
        <div>
          <span className="text-sm font-bold text-foreground tracking-tight">NIRF Ranking</span>
          <span className="block text-[10px] font-medium text-muted-foreground uppercase tracking-widest">Management System</span>
        </div>
      </div>
